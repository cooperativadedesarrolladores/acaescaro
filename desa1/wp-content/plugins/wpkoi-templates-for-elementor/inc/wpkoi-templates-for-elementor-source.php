...
class WPKoi_Elementor_Lite_Templates_Source extends Elementor\TemplateLibrary\Source_Base {

	/**
	 * Template prefix
	 */
	protected $template_prefix = 'wpkoi_';
	...
	public function get_id() {
		return 'wpkoi-templates';
	}

	public function get_title() {
		return __( 'WPKoi Templates', 'wpkoi-templates-for-elementor' );
	}
	...
	public function get_items( $args = array() ) {
		...
		$url            = WPKOI_TEMPLATES_FOR_ELEMENTOR_URL . 'json/templates.json';
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		$url        = 'https://wpkoi.com/wet/json/' . $filename . '.json';
		$response   = wp_remote_get( $url, array( 'timeout' => 60 ) );
		$body       = wp_remote_retrieve_body( $response );
		$body       = json_decode( $body, true );
