	...
	class WPKoi_Elements_Lite_Integration {
		...
		public function enqueue_styles() {
			...
			if ( $wtfe_countdown != true ) {
				...
				wp_enqueue_script('wpkoi_elements_elementor-countdown-js',WPKOI_ELEMENTS_LITE_URL.'elements/countdown/assets/countdown.min.js', array('jquery'),'1.0', true);
			}
			
			if ( $wtfe_darkmode != true ) {
				wp_enqueue_script('darkmode',WPKOI_ELEMENTS_LITE_URL.'elements/darkmode/assets/darkmode-js.min.js', array('jquery'),WPKOI_ELEMENTS_LITE_VERSION, true);
			...
			if ( $wtfe_qr_code != true ) {
				wp_enqueue_script('wpkoi-qrcode',WPKOI_ELEMENTS_LITE_URL.'elements/qr-code/assets/jquery.qrcode.min.js', array('jquery'),WPKOI_ELEMENTS_LITE_VERSION, true);
			}
