	...
	if(has_post_thumbnail())  {
		...
		if (!is_single()){ ?></a><?php }
			...
			if (!is_page()) {?><p class='post-meta'>
				...
				<span class='post-date'><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/post-meta-list.png" class="meta-com-img"><?php echo get_the_date(); ?></span>
				
				<span class='post-category'><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/post-meta-list.png" class="meta-com-img"><?php the_category(', '); ?></span>
				<?php
				if(comments_open( get_the_ID() ))  {
                    ?> <span class='post-comments'><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/post-meta-list.png" class="meta-com-img"><?php comments_popup_link( $SMTheme->_( 'noresponses' ), $SMTheme->_( 'oneresponse' ), $SMTheme->_( 'multiresponse' ) ); ?></span>
				<?php } 
